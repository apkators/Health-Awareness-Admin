...
import com.health.threat.awareness.admin.app.AppPreferenceManager;
import com.health.threat.awareness.admin.model.Admin;
import com.health.threat.awareness.admin.util.InternetDialog;
                    ...
                    mAuth.signInWithEmailAndPassword(email, password)
                            .addOnCompleteListener(LoginActivity.this, task -> {
                                if (task.isSuccessful()) {
                                    ...
                                    databaseReference.child("Admins").child(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
