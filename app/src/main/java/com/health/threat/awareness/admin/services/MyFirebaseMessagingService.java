...
import com.health.threat.awareness.admin.notification.FirebaseNotification;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull String s) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            databaseReference = FirebaseDatabase.getInstance().getReference().child("DeviceTokens").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
